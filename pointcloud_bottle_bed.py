...
def start_ros_system():
    ...
    "{{trajectory: {{joint_names: [shoulder_pan_joint, shoulder_lift_joint, elbow_joint, wrist_1_joint, wrist_2_joint, wrist_3_joint], points: [{{positions: [4.558537006378174, -0.3419717115214844, -1.4476462602615356, -2.2719394169249476, 1.6401886940002441, -1.6181018988238733], time_from_start: {{sec: 20, nanosec: 0}}}}]}}}}"
    """
